...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(41569318498670304)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(41569626956670304)
,p_plug_template_id=>wwv_flow_api.id(41569318498670304)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(41569986471670304)
,p_plug_template_id=>wwv_flow_api.id(41569318498670304)
,p_name=>'Tabs'
