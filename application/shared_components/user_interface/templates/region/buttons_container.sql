...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(41542274186670290)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(41542513126670290)
,p_plug_template_id=>wwv_flow_api.id(41542274186670290)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(41542823365670290)
,p_plug_template_id=>wwv_flow_api.id(41542274186670290)
,p_name=>'Sub Regions'
