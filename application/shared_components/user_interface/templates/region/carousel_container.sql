...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(41532599697670284)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(41532807160670285)
,p_plug_template_id=>wwv_flow_api.id(41532599697670284)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(41533101471670285)
,p_plug_template_id=>wwv_flow_api.id(41532599697670284)
,p_name=>'Slides'
