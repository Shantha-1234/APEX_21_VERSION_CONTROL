...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(41547635036670292)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(41547951509670292)
,p_plug_template_id=>wwv_flow_api.id(41547635036670292)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(41548282933670293)
,p_plug_template_id=>wwv_flow_api.id(41547635036670292)
,p_name=>'Sub Regions'
