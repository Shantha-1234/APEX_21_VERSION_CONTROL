...
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(41717982471672710)
,p_lov_name=>'VIEW_AS_REPORT_CHART'
,p_lov_query=>'.'||wwv_flow_api.id(41717982471672710)||'.'
,p_location=>'STATIC'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(41718208399672711)
...
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(41718663474672711)
